...
public class GameMapImplTest {
    ...
    public void should_able_to_move_to_another_place() {
        Place starting = new Estate(10000, 0);
        Place estate2 = new Estate(10000, 0);
        Place estate3 = new Estate(10000, 0);
        Place estate4 = new Estate(10000, 0);
        GameMap map = new GameMapImpl(2, 2, starting, estate2, estate3, estate4);
    ...
    public void should_stop_if_pass_block_or_bomb_when_move() {
        ...
        Place estate3 = new Estate(10000, 0);
        Place estate4 = new Estate(10000, 0);
        GameMapImpl map = new GameMapImpl(2, 2, starting, bomb, estate3, estate4);
    ...
    public void should_set_tool_to_the_right_place() {
        ...
        Place estate3 = new Estate(10000, 0);
        Place estate4 = new Estate(10000, 0);
        GameMapImpl map = new GameMapImpl(2, 2, starting, estate2, estate3, estate4);
    ...
    public void should_clean_the_other_tools_around_10_if_use_robot() {
        Place starting = new Estate(10000, 0);
        Place bomb = new BombPlace(new Estate(10000, 0));
        Place estate3 = new Estate(10000, 0);
        Place block = new BlockPlace(new Prison());
        GameMapImpl map = new GameMapImpl(2, 2, starting, bomb, estate3, block);
    ...
    public void should_go_to_hospital_and_remove_bomb_after_pass_the_bomb_place() {
        ...
        GameMapImpl map = new GameMapImpl(2, 2, starting, bomb, estate3, hospital);
    ...
    public void should_go_to_the_place_where_the_block_is_put_and_remove_block_after_pass_the_block_place() {
        ...
        Place estate3 = new Estate(10000, 0);
        Place hospital = new Hospital();
        GameMapImpl map = new GameMapImpl(2, 2, starting, block, estate3, hospital);
